...
import { STAGE_AR, entryDir, entryPath, evidenceDir, freqAr, newEntryId, roleAr } from "./app.js?v=bab17f74";
import { currentWeek, fillContext, semesterLabel } from "./autofill.js?v=bab17f74";
import { committeeMeetings, meetingScope, meetingTitle, nextMeeting } from "./meetings.js?v=bab17f74";
import { printRecord } from "./print.js?v=bab17f74";
import { UNSUPPORTED, buildGuide, buildLabelCanon, renderRecordForm, setFillContext } from "./record.js?v=bab17f74";
import { $, esc, markNav, only } from "./ui-state.js?v=bab17f74";
import { backupEntry } from "./vault.js?v=bab17f74";
import { draftId, saveDraft, loadDraft, clearDraft, markSaved, setSaver, markDirty } from "./draft.js?v=bab17f74";
