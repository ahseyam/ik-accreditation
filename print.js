import { interpolate, interpScope, arabizeText, stripDecor, headingLevel, isSerialCol, isNoiseCol } from "./record.js?v=4a7ac37e";
import { standaloneAssets, page, wrap } from "./standalone.js?v=4a7ac37e";
