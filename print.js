import { interpolate, interpScope, arabizeText, stripDecor, headingLevel, isSerialCol, isNoiseCol } from "./record.js?v=0e5e4e87";
import { standaloneAssets, page, wrap } from "./standalone.js?v=0e5e4e87";
