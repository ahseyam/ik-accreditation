import { interpolate, interpScope, arabizeText, stripDecor, headingLevel, isSerialCol, isNoiseCol } from "./record.js?v=bab17f74";
import { standaloneAssets, page, wrap } from "./standalone.js?v=bab17f74";
