...
/* ⚠️ **تناقضٌ كشفته تجربة الوكيل**: ورقة المشاركة تمنح صلاحية التحرير على
   مجلد المدرسة لاثنين — الوكيل التعليمي ومنسق الجودة — ثم كان الموقع يمنع
   الوكيل من تحرير الخطة. فيملك الكتابة في الملفّ ولا يجد أين يكتب.
   الثلاثة هم من يحرّر: المدير ومنسق الجودة والوكيل التعليمي. */
const PLAN_EDITORS = new Set([...OVERSEER_ROLES, "EDUCATIONAL_VP"]);
export const canEditPlans = (role) => PLAN_EDITORS.has(role);
