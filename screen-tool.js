...
import { $, esc, only, markNav, setStatus } from "./ui-state.js?v=8501d2bd";
import { flattenTool, scaleMax, levelFromEvidence, isEvidenceBased, isVerification,
         evidenceFromRecords, toolResponsePath } from "./tools.js?v=8501d2bd";
import { newEntryId } from "./app.js?v=8501d2bd";
import { backupEntry } from "./vault.js?v=8501d2bd";
import { renderPublish } from "./publish.js?v=8501d2bd";
