...
import { $, esc, only, markNav, setStatus } from "./ui-state.js?v=4dd3cd8b";
import { flattenTool, scaleMax, levelFromEvidence, isEvidenceBased, isVerification,
         evidenceFromRecords, toolResponsePath } from "./tools.js?v=4dd3cd8b";
import { newEntryId } from "./app.js?v=4dd3cd8b";
import { backupEntry } from "./vault.js?v=4dd3cd8b";
import { renderPublish } from "./publish.js?v=4dd3cd8b";
