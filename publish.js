...
import { surveyLink, extractCodes } from "./survey.js?v=0e5e4e87";
import { newEntryId } from "./app.js?v=0e5e4e87";
import { saveSettings } from "./vault.js?v=0e5e4e87";
import { toolResponsePath, scaleMax } from "./tools.js?v=0e5e4e87";
