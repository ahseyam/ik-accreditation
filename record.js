import { agendaForMeeting, meetingTitle, meetingScope, committeeMeetings, fmtDate } from "./meetings.js?v=3c2900a0";
import { derive, seedRows, committeePositionAr } from "./autofill.js?v=3c2900a0";
