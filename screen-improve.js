...
import { $, esc, only, markNav } from "./ui-state.js?v=a7aa9546";
import { buildImprovementPlan, buildImprovementMirror, PROC_COLUMNS, shortLabel,
         indicatorTag, TOTAL_WEEKS, WEEKS_PER_SEMESTER } from "./improve.js?v=a7aa9546";
import { loadToolResponses } from "./app.js?v=a7aa9546";
import { summarize, rollupByIndicator } from "./tools.js?v=a7aa9546";
